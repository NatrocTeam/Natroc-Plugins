...
| [`supabase`](./plugins/supabase)                         | Supabase plugin with skills for Postgres best practices, schema design, query optimization, RLS, and MCP integration for managing Supabase projects.                                                               |
| [`threejs`](./plugins/threejs)                           | Three.js 3D graphics guidance - 10 skills covering scenes, geometry, materials, shaders, lighting, animation, interaction, loaders, textures, and post-processing.                                                 |
