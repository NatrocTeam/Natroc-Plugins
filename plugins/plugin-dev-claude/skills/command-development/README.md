...
- Integration patterns for agents, skills, hooks, and scripts
- Validation patterns for arguments, files, resources, and error handling
- Interactive commands with `AskUserQuestion`
- Advanced multi-step workflows
- Testing strategies for command behavior
- Documentation patterns for user-facing and agent-facing commands
- Marketplace considerations for packaged command distribution
...
- Added interactive command guidance.
- Added advanced workflows, testing strategies, documentation patterns, and
  marketplace considerations.
- Expanded plugin command patterns and validation guidance.
