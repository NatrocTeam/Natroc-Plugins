...
2. **Fetch the latest upgrade guide**: Use WebFetch to get the official upgrade documentation:
   - Codemods: https://nextjs.org/docs/app/guides/upgrading/codemods.md
   - Version-specific guides (adjust version as needed):
     - https://nextjs.org/docs/app/guides/upgrading/version-16.md
     - https://nextjs.org/docs/app/guides/upgrading/version-15.md
     - https://nextjs.org/docs/app/guides/upgrading/version-14.md
