...
├── global-error.tsx    # Global error UI# File Conventions

Next.js App Router uses file-based routing with special file conventions.

## Project Structure

Reference: https://nextjs.org/docs/app/getting-started/project-structure.md
...
Reference: https://nextjs.org/docs/app/api-reference/file-conventions.md
