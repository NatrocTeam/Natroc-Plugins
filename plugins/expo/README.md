...
Official AI agent skills from the Expo team for building, deploying,
upgrading, and debugging Expo apps. This plugin is packaged for Claude Code and
Codex with local skills, Claude Code agents, and one setup command for Codex run
actions.
...
- Install Plugin
  ...
  ```
  claude plugin install expo@natroc-plugins
  ```
...
- Install Plugin
  ```
  codex plugin add expo@natroc-plugins
  ```
