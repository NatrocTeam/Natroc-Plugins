...
export function buildMeasurementPlan(result) {
  ...
  const toolsets = [
    createToolset({
      ...
      starterPack: {
        ...
        focus:
          "Validate sample size, cold-start versus warm-cache behavior, and estimate drift over time.",
      },
    }),
    createToolset({
      ...
      starterPack: {
        ...
        focus:
          "Score success, retries, and manual intervention across a fixed prompt set.",
      },
    }),
    createToolset({
      id: "tool-call-audit",
      ...
      starterPack: {
        ...
        focus:
          "Flag wrong tool selection, malformed args, and missing follow-up calls.",
      },
    }),
    createToolset({
      ...
      starterPack: {
        ...
        focus:
          "Measure time-to-value and cost-per-success on a stable prompt suite.",
      },
    }),
    createToolset({
      ...
      starterPack: {
        ...
        focus:
          "Collect 1 to 5 scores for clarity, trust, and edit burden across a small evaluator panel.",
      },
    }),
  ];
    ...
    toolsets.push(
      createToolset({
        ...
        starterPack: {
          ...
          focus:
            "Blend repository test outcomes with evaluation-task success metrics.",
        },
      }),
    );
  }
  ...
  const payload = {
    ...
    artifact: createArtifact({
      ...
      description:
        "Recommended toolsets for measuring the real-world effect of this skill or plugin.",
      data: {
        recommendedToolsets,
        toolsets,
      },
